  ...
  <div class="layout-2cols">
      <div class="blog-page">
          ...
          <div class="content grid_8 main-info">
              <h3 class="rs title-detail"><a href="post.html">QUY ĐỊNH VỀ HOÀN TIỀN</a></h3>
          </div>
          <iframe src="https://docs.google.com/document/d/e/2PACX-1vRGzDPY2t8p4kFzjhECGIB-2tIzCgD-xYGc8clprcaEJYaQmOghAKZf7afURkUM0aBNZLjuunfr45wV/pub?embedded=true" width="900" height="1200"></iframe>
              <div class="clear"></div>
          </div><!--end: .content -->
        </div>
