  ...
  <div class="layout-2cols">
      <div class="blog-page">
          ...
          <div class="content grid_8 main-info">
              <h3 class="rs title-detail"><a href="post.html">QUY ĐỊNH VỀ CHI PHÍ GỌI VỐN</a></h3>
          </div>
          <iframe src="https://docs.google.com/document/d/e/2PACX-1vRSggj-a2jB7AfY3NJ0K-PqWcXmcB9BMAWdOoJpDG5d68jSr1edqr_I-YklIXrNS9bsdTuRURnCLtJQ/pub?embedded=true" width="900" height="1200"></iframe>
              <div class="clear"></div>
          </div><!--end: .content -->
        </div>
