...
@section('title','Huong dan su dung')
@section('header')
  <meta charset="utf-8">
  ...
  <div class="layout-2cols">
      <div class="blog-page">
          ...
          <div class="content grid_8 main-info">
              <h3 class="rs title-detail"><a href="#">HƯỚNG DẪN SỬ DỤNG</a></h3>
          </div>
              <iframe src="https://docs.google.com/document/d/e/2PACX-1vQKlztq0n-QWn5GtCfMuli-YS30Yk3d3W8kxHBDx_nMCHqpax_koaOqFjNM9jLvDVrOAT_ozENsK51a/pub?embedded=true" width="900" height="1200"></iframe>
              <div class="clear"></div>
          </div><!--end: .content -->
        </div>
