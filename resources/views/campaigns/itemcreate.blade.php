	...
	@section('content')
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					...
					<br>
					<br>
						<a class="btn btn-w-m btn-success " href="{{ url('overview/'.$id) }}">Overview</a>
					</div>
					<div class="col-lg-2">
					<br>
					<br>
					...
					{{ csrf_field() }}
						<button type="submit" class="btn btn-w-m btn-success ">Launch Campaign</button>
					</form>
					</div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="ibox-content">
                            <h2>
                                <span class="text-navy">Chi tiết về sản phẩm</span>
                            </h2>
							<h4> Sản phẩm thuộc gói đầu tư mà bạn muốn đem lại cho người ủng hộ</h4>
                            <div class="ibox-content">
								<div class="row">
                                    <div class="col-sm-9" >
										<form  method="POST" action="/itemstore/{{ $id }}" role="form" id="form" enctype="multipart/form-data">
										{{ csrf_field() }}
											<div class="form-group"><label>Tên sản phẩm *</label> <input id = "item_name" name="item_name" type="text" value="" class="form-control"></div>
											...
											<div class="form-group">
											   ...
											   <p>
												...
												<div class="form-inline" id="show_option" ><label>Tên tùy chọn</label> 
													<input id = "option_name" name="option_name" type="text" placeholder="Size"  class="form-control">
													<label>Giá trị tùy chọn</label> 
													<input id="option_value" name="option_value" type="text" placeholder="Small,Medium,Large" class="form-control">
