					...
					<div class="col-lg-12">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="ibox-content">
								<div class="row">
								<div class="col-sm-9 ">
								<form  method="POST" action="/perkstore/{{ $id }}" role="form" id="form" enctype="multipart/form-data">
								{{ csrf_field() }}
                                    <div class="form-group"><label>Giá *</label> <input id = "price" name="price" type="text" value="" class="form-control"></div>
                                    <div class="form-group"><label>Giá bán lẻ</label> <input id="retailprice" name="retailprice" type="text" value=""  class="form-control"></div>
									<div class="form-group"><label>Tên gói đầu tư *</label> <input id = "title" name="title" type="text" value="" class="form-control"></div>
									...
									<div class="form-group"><label>Mô tả *</label> <textarea  id = "description" rows="4" cols="50" name="description"  value="" class="form-control"></textarea></div>
									
									<div class="form-group"><label>Số lượng có sẵn</label> <input id="total_quantily" name="total_quantily" type="text"  class="form-control"></div>
